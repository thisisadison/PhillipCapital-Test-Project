...
export const CONDUCT_DOMAIN = registerAuditDomain({
  ...
  dimensions: [
    ...
    },
    {
      ...
      options: [
        ...
        { id: "digital-marketing", label: "Digital marketing and social media", hint: "Disclaimers rarely survive a short format" },
        { id: "affiliates", label: "Affiliate, referral or influencer promotion", hint: "The firm remains responsible for it" },
        { id: "outbound-contact", label: "Outbound calling or unsolicited contact", hint: "Do Not Call obligations" },
  ...
  themes: [
    ...
    { id: "advertising", label: "Advertising and marketing", scope: "Standards for promotional material, including balance, prominence of risk, substantiation of claims, and approval before use." },
    { id: "unsolicited-contact", label: "Unsolicited contact and marketing data", scope: "Do Not Call obligations, consent for marketing messages, and the use of customer data to target them." },
