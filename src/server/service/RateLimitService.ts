 ...
 *
 * Two independent limits, guarding different things: a cooldown against any
 * recent run (a digest produced ten minutes ago will not change if you ask
 * again), and a daily ceiling on manual runs specifically (this is a shared tool
 * and each run costs real API spend).
 *
