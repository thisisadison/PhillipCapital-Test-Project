/**
 * Date helpers for the digest. Everything the reader sees is expressed in the
 * team's own timezone, so an edition dated "8 September" is the 8th in
 * Singapore regardless of where the job ran.
 *
...
/** "8 Sep" — for the archive list and the coverage range. */
...
/**
 * "8 Sep 2026, 06:14 SGT" — the generation timestamp. Always rendered in full
...
/** Coarse, human phrasing for how old something is. Used alongside, never instead of, the timestamp. */
